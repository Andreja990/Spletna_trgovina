...
if ($result!=null) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
        <tr>
        <td class="tabela-link-brez"><a href="/andreja_projekt/izdelek-admin.php?izdelek=<?php echo $row['artikel']?>"><?php echo $row['artikel']?></a></td>
        <td><?php echo $row['kolicina']?></td>
        <td><?php echo $row['velikost']?></td>
        <td class="tabela-link"><a href="/andreja_projekt/uporabnik-pregled.php?uporabnik=<?php echo $row['uporabnik']?>"><?php echo $row['uporabnik']?></a></td>
