...
<select name="cena" id="cena">
    <option value="Najnizja">Najnižja dalje</option>
    <option value="Najdrazja">Najdražja dalje</option>
</select>
<br><br>
...
if (isset($_POST['filtri'])) {
    ...
    if ($result_filtri!=null) {
        ...
        while ($row = $result_filtri->fetch_assoc()) {
            ...
            <h4>
            <a href="/andreja_projekt/izdelek-admin.php?izdelek=<?php echo $row['naziv']?>"><?php echo $row['naziv']?></a>
            </h4>
